...
import { getDashboardDistanceData } from "../../store/actions";

const PermittedDistanceData = ({id}) => {
  ...
  useEffect(() => {
    dispatch(getDashboardDistanceData(authtoken, 'distance', id, startDateRange, endDateRange));
...
export default PermittedDistanceData;
