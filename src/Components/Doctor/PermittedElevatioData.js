...
import { getDashboardElevationData } from "../../store/actions";

const PermittedElevationData = ({id}) => {
  ...
  useEffect(() => {
    dispatch(getDashboardElevationData(authtoken, 'elevation', id, startDateRange, endDateRange));
...
export default PermittedElevationData;
